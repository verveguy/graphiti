...
- Neo4j 5.26 / FalkorDB 1.1.2 / LadybugDB 0.15+ / Amazon Neptune Database Cluster or Neptune Analytics Graph + Amazon
...
If you plan to use LadybugDB as your graph database backend, install with the ladybug extra:
...
driver = LadybugDriver(db="/tmp/graphiti.ladybug")
